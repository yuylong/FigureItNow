...
void finExecAlg::listVectorNorm(const QList<double> &inlist, double *outval)
{
    if ( outval == nullptr ) {
        finThrow(finErrorKits::EC_NULL_POINTER, "The output variable is null.");
    }
...
void finExecAlg::listVectorNorm1(const QList<double> &inlist, double *outval)
{
    if ( outval == nullptr ) {
        finThrow(finErrorKits::EC_NULL_POINTER, "The output variable is null.");
    }
...
void finExecAlg::listVectorNormP(const QList<double> &inlist, double p, double *outval)
{
    if ( outval == nullptr ) {
        finThrow(finErrorKits::EC_NULL_POINTER, "The output variable is null.");
    }
...
void finExecAlg::listVectorNormInf(const QList<double> &inlist, double *outval)
{
    if ( outval == nullptr ) {
        finThrow(finErrorKits::EC_NULL_POINTER, "The output variable is null.");
    }
...
void finExecAlg::listVectorNormalize(const QList<double> &inlist, QList<double> *outlist)
{
    if ( outlist == nullptr ) {
...
void finExecAlg::listVectorDot(const QList<double> &inlist1, const QList<double> &inlist2, double *outval)
{
    if ( outval == nullptr ) {
        finThrow(finErrorKits::EC_NULL_POINTER, "The output variable is null.");
    }
...
void finExecAlg::varVectorNorm(finExecVariable *invar, finExecVariable *outvar)
{
    if ( invar == nullptr || outvar == nullptr )
        finThrow(finErrorKits::EC_NULL_POINTER, "Input or output variable is null.");
    if ( !invar->isNumericArray() )
    ...
    double outval = 0.0;
    listVectorNorm(inlist, &outval);

    outvar->setType(finExecVariable::TP_NUMERIC);
    outvar->setNumericValue(outval);
}

void finExecAlg::varVectorNorm1(finExecVariable *invar, finExecVariable *outvar)
{
    if ( invar == nullptr || outvar == nullptr )
        finThrow(finErrorKits::EC_NULL_POINTER, "Input or output variable is null.");
    if ( !invar->isNumericArray() )
...
void finExecAlg::varVectorNormP(finExecVariable *invar, finExecVariable *pvar, finExecVariable *outvar)
{
    ...
    double outval = 0.0;
    listVectorNormP(inlist, p, &outval);
...
void finExecAlg::varVectorNormInf(finExecVariable *invar, finExecVariable *outvar)
{
    ...
    double outval = 0.0;
    listVectorNormInf(inlist, &outval);
...
void finExecAlg::varVectorDot(finExecVariable *invar1, finExecVariable *invar2, finExecVariable *outvar)
{
    ...
    double outval = 0.0;
    listVectorDot(inlist1, inlist2, &outval);
...
void finExecAlg::varMatDot(finExecVariable *invar1, finExecVariable *invar2, finExecVariable *outvar)
{
    if ( invar1 == nullptr || invar2 == nullptr || outvar == nullptr )
        finThrow(finErrorKits::EC_NULL_POINTER, "Input or output variable is null.");
